    ...
    <div className='h-[100vh] w-full bg-cover bg-center py-[20px] px-[8%]' style={{
      ...
      <div className='w-[100%] max-w-[450px] bg-black opacity-[0.75] rounded-[4px] p-[60px] m-auto'>
        ...
        <form  onSubmit={user_auth}>
          ...
          {/* //~sign in button */}
          <input className='h-[50px] text-white my-[12px] mt-[20px] border-0 outline-0 rounded-[4px] p-[16px] bg-[#e50916] hover:bg-[#c50916] text-[16px] font-medium  w-[100%] cursor-pointer' type="submit" value="Sign in" />
          {/* //~Or label */}
