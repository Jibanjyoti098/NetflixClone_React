    ...
    <div className='h-[100vh] w-full bg-cover bg-center py-[20px] px-[8%]' style={{
      ...
      <div className='w-[100%] max-w-[450px] bg-black opacity-[0.75] rounded-[4px] p-[60px] m-auto'>
        ...
        <form>
          ...
          {/* //~sign-up button */}
          <input className='h-[50px] text-white my-[12px] mt-[20px] border-0 outline-0 rounded-[4px] p-[16px] bg-[#e50916] hover:bg-[#c50916] text-[16px] font-medium  w-[100%] cursor-pointer' type="button" value="Sign Up" />
          ...
          <div className='flex  justify-between text-[#b3b3b3] text-[16px] flex-col'>
            ...
            <div className='mb-2'>
              ...
              <label className='font-bold text-white hover:underline cursor-pointer'>Sign-in now.</label>
            </div>
          </div>
          {/* //~Learn and message  */}
          <div>
